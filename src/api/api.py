...
search_params = [
    'q', 'sort', 'city', 'country', 'hometown', 'university_country',
    'university', 'university_year', 'university_faculty',
    'university_chair', 'sex', 'status', 'age_from', 'age_to',
    'birth_day', 'birth_month', 'birth_year', 'online', 'has_photo',
    'school_country', 'school_city', 'school_class', 'school',
    'school_year', 'religion', 'company', 'position', 'group_id', 'from_list'
    ]
